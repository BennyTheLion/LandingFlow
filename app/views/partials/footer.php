...
<div class="whatsapp-tooltip" id="waTooltip">דברו איתנו בוואטסאפ :-)</div>
...
function toggle(){isOpen=!isOpen;win.classList.toggle("open",isOpen);if(isOpen){unread=0;badge.style.display="none";inp.focus();try{document.getElementById("agentFloat").style.right="404px"}catch(e){}}else{try{document.getElementById("agentFloat").style.right="24px"}catch(e){}}}
btn.addEventListener("click",toggle);close.addEventListener("click",function(){isOpen=false;win.classList.remove("open")});
